...
const ModalToConfigGame = () => {
  const TranslateGenderCategory = (
    genderCategoryInEnglish: GenderOptionsProps,
  ) => {
  ...
  const { genderAndSportCategorySelected, sportAndCourseSelected } =
    PageDisputaRegistrarConnection();
  const sportSelected = sportAndCourseSelected.sportSelected.value;

  const { genderCategorySelected, sportCategorySelected } =
  ...
  return (
    <ModalTemplate modal={modalToConfigGame}>
