  ...
  return (
    <div className={'home-page-cards'}>
      <div className={'home-page-cards__grid-top'}>
        <HomePageCard
          link="/"
          title="equipes por curso"
          illustration={<IllustrationCourse />}
        />
        <HomePageCard
          link="/"
          title="jogos esportivos"
          illustration={<IllustrationJogosEsportivos />}
        />
        <HomePageCard
      ...
      <div className={'home-page-cards__grid-left'}>
        <HomePageCard
          link="/"
          title="recordes desta edição"
          illustration={<IllustrationEdicoesDaSemadec />}
        />
        <HomePageCard
          link="/"
          title="publicações sobre a semadec"
          illustration={<IllustrationPublicacoesSobreSemadec />}
        />
      </div>
      <div className={'home-page-cards__grid-right'}>
        <HomePageCard
          ...
          illustration={<IllustrationRecordesDestaEdicao />}
        />
        <HomePageCard
          link="/"
